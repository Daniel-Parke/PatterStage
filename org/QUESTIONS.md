...
### Q-002 · Which licence does the public repository carry?
- raised: Session 0, by measurement rather than by the operator.
- the conflict: LICENSE, package.json, README and NOTICE all say Apache-2.0;
  GitHub's repository metadata reports MIT. The two differ materially on patent
  grant and attribution.
- why it matters now: the repository is public with 11 forks and 52 stars, so
  people have already taken copies under whichever they read.
- who answers: the operator. It is a legal question, not a technical one, and
  nothing in the seed should decide it.
