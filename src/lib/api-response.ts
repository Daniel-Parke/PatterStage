 ...
 *  goes through `requireNotReadOnly` in `@/lib/api-auth`, whose message carries the env-var hint. */
 ...
 * rather than with the catch-block shims in `@/lib/api-logger`. The parameter
