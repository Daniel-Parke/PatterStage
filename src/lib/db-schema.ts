 ...
 * equals `NEUTRAL_COLUMN_NAMES_SCHEMA_VERSION` (the last applier's gate) and
 * equals the highest-numbered file in `src/lib/db/migrations/`.
 *
 ...
 */
export const MIGRATION_HEAD_SCHEMA_VERSION = 30;
