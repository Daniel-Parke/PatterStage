...
export const HINDSIGHT_TEXT_INPUT_CLASS =
  "w-full bg-ps-surface-inset border border-ps-edge rounded-ps-md px-3 py-2 text-body text-ps-text-primary focus:";
...
export const HINDSIGHT_TEXTAREA_CLASS =
  "bg-ps-surface-inset border border-ps-edge rounded-ps-md p-3 text-body text-ps-text-primary resize-none focus:";
