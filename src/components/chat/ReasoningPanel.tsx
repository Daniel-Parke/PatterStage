  ...
  return (
    <div className="mb-2 rounded-lg border border-neon-purple/20 bg-neon-purple/[0.06]">
      <button
        ...
        className="flex w-full items-center gap-1.5 px-2.5 py-1.5 text-xs font-mono text-neon-purple hover:text-neon-purple"
      >
      ...
      {open && (
        <div className="border-t border-neon-purple/15 px-3 py-2 text-xs leading-relaxed text-ps-text-muted whitespace-pre-wrap">
          {reasoning}
        </div>
      )}
    </div>
