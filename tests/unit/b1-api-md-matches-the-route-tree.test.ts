/**
 * B1 (T-0095), D129: docs/API.md says "Every route.ts under src/app/api has a
...
const API_MD = readFileSync(join(ROOT, "docs", "API.md"), "utf-8");
...
describe("docs/API.md and src/app/api agree", () => {
